...
describe('StartLoginPage',()=>{
  ...
  it('StartLoginPage render isLogin true',  ()=>{
    useSelectorMock.mockReturnValueOnce(true)
                  .mockImplementationOnce(()=> contentImgItems)
                  .mockImplementationOnce(()=> carouselItems)
                  .mockImplementationOnce(()=> cardsInfo)
    renderWithRedux(<Router history={history}><StartLoginPage/></Router>)
    expect(screen.queryByText('VIKINGER')).not.toBeInTheDocument()
  })
  it('StartLoginPage render isLogin false',  ()=>{
