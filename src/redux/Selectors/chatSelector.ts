...
export const getMessagesSelector = (state: AppStateType) => state.chatReducer.messages
export const getStatusSelector = (state: AppStateType) => state.chatReducer.status
